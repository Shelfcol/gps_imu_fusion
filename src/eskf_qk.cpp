...
ESKFQK::ESKFQK(const YAML::Node &node) {
    ...
    double cov_prior_accel = node["qk_covariance"]["prior"]["accel_delta"].as<double>();
    double cov_prior_gyro = node["qk_covariance"]["prior"]["gyro_delta"].as<double>();
    double cov_prior_g = node["qk_covariance"]["prior"]["g_delta"].as<double>();
    double cov_process_vel = node["qk_covariance"]["process"]["vel_delta"].as<double>();
    double cov_process_ori = node["qk_covariance"]["process"]["ori_delta"].as<double>();
